%\vspace{-0.2in}
\paragraph{Security theorem.} The protocols we generate provide
simulation-based security against a semi-honest adversary, in the
framework of ~\cite{gmw,can00,can01}\dg{ and provides provable security against all side-channel attacks}. At a very high level, in this
