...
inner product of  $w$ and $x$. Alice has following options.
...
and require the programmers to perform them explicitly. 
...
while maintaining provable correctness, security, and efficiency.
...
These situations arise seldomly in the machine learning applications that we consider:
intermediate values don't need to be declassified and arrays are traversed in an oblivious manner.
