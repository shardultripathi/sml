...
We note that doing an optimal split between arithmetic and boolean is an NP-hard problem and in this work, we use some heuristics based on costs observed using microbenchmarking. 
