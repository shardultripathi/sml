...
We elaborate on cryptographic cost awareness in \sectionref{ccc}.
...
We note that doing an optimal split between arithmetic and boolean is an \dg{NP-hard} problem and in this work, we use some heuristics based on costs observed using microbenchmarking. 
