...
communication in a LAN setting). Theoretically, the size of a boolean multiplication circuit is quadratic in the bit-width, which causes this performance gap.
