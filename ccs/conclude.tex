...
\dg{Add other future work such as language enhancement to support public inputs, declassification of intermediate values, secret array indices and support of ORAM. But since current focus was ML applications, didn't require these as such. Also, crypto backends would keep improving and although our ideas extend to works such as Gazelle, we leave integrating it as a backend in \tool as future work.}
