...
\label{sec:conclude}
\dg{Make it consistent with contributions in intro.}
...
\dg{Add other future work such as language enhancement to support public inputs, declassification of intermediate values, secret array indices and support of ORAM. But since current focus was ML applications, didn't require these as such. Also add functions. Also, crypto backends would keep improving and although our ideas extend to works such as Gazelle, we leave integrating it as a backend in \tool as future work.

We will explore the possibility of mechanically verifying the implementation of our compiler.
