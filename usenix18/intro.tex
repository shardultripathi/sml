...
subject to errors (a sentiment echoed by Demmler et al.~\cite{aby} themselves).
...
the that generic \mpc implementations are much more efficient than what they were believed to be. 
...
of our scheme against semi-honest (or, ``honest but curious") adversaries
 to the semi honest security of the  \mpc back-end. 
