...
program as output. \figureref{ex-aby} shows the output code\footnote{This is also how a program written directly in
  ABY would look like.} for
the example in \figureref{ex-sml}. The output program
...
a \mpc protocol.
\vspace{-0.1in}
\paragraph{Salient features of \tool.} We can now concretely see the advantages of \tool. Unarguably, it is
...
revisit many parts of the circuit and change them. To summarize, \tool raises the level of abstraction for the
