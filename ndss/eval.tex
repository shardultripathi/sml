...
are related to machine learning and we use largely standard notation. We provide further details on these benchmarks in the full version of this paper. %set up (largely standard) notation and describe our benchmarks in \appendixref{benchmarks}.
