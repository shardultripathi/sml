...
circuit~(\cite{yao,gmw}) or an arithmetic circuit~(\cite{sss,viff,gentry}). \TODO{check!}
%
...
of our compiler to the security of the  \mpc back-end
 (by also invoking our correctness theorem). We also prove a formal security theorem for our partitioning
scheme.
