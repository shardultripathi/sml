...
\mpc. With the current techniques, he has three options. \aseem{We should
...
to be used by non-specialist programmers. \divya{since they say in future they want to automate the splitting.}
...
the performance or outperform hand-crafted protocols in most cases (see
\sectionref{eval}). \divya{Moreover, unlike previous systems, our system can scale to arbitrarily large computations using {\em pipelining} (see below). What do we say about Yao pipelining?}
Hence, we show that our framework achieves all three properties of generality, performance and programmer productivity. 

\divya{Points.. 1. Prior to our work, there was CBMGC no perf; ABY no prog; 
3. Programmability allows writing programs generating large circuits... 
}
