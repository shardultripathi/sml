...
combinations (e.g. \cite{bogdanov,lone,tasty}). However, as Demmler et
...
protocol. Additionally, these prior works neither have
a developer-friendly language, nor do they formalize their type
system and operational semantics, and show them to be
consistent. Kerschbaum et al.~\cite{autoS}
provide a scheme to automatically select optimal protocols
for sub-compuations, but they consider a toy language consisting only
of arithmetic expressions. We provide a detailed survey of related
