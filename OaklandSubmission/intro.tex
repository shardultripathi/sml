...
Suppose a developer wants to compute $w^Tx >0$ securely using
...
In this work, we develop and implement our framework \tool \nc{I still
  like EasyPC :)} \divya{I agree that \tool is bad. What would be the
  full form for EasyPC? Shouldn't it be EasySC?} for secure
...
that protocols generated by our compiler match (\aseem{or better?})
the performance of hand-crafted protocols in most cases (see
