...
The results for linear classification are in Table~\ref{tab:lc}. The
...
We observe that \tool generated code has performance competitive
to~\cite{shafindss}.
...
single 32-bit integer comparison with zero. The number of
multiplication gates (\#Mul) is the same as the model size $d$. The
