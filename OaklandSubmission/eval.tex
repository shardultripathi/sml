...
The results for Na\"{i}ve Bayes are in Table~\ref{tab:nb}. As before, $n$ denotes the length of the input feature vector $x=(x_1,\ldots,x_n)$ and $F$ is the number of possible values of each $x_i$.
