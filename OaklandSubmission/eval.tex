...
%degree linear in depth of the tree) and then
 the prediction task
reduces to polynomial evaluation~\cite{shafindss}.
...
$-1 < y < 1$ and $\mathrm{sign}(y)$ otherwise ($f$ on vectors and matrices is defined point-wise on every element of the vector/matrix). \bonsai can be
