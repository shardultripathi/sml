...
%\end{enumerate}
\nc{First pass of the related work.}\\
\nc{ABY have a list of papers that combine boolean and arithmetic compute (hand crafted protocols). We can cite them in the intro or somewhere else to say all those can be automated.}
