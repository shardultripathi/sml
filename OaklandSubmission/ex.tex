...
$\mathtt{
\}\;else\;\{\;\;\text{{\color{blue}//role == CLIENT}}
}$  
  //Put gates to read x
$\mathtt{
\}
...
$\mathtt{
for(uint32\_t\;i\;=\;0;\;i\;<\;30;\;i = i + 1)\;\{\;\;\text{\color{blue}//acc = w}^{\text{{\color{blue}T}}}\text{\color{blue}x}~\label{line:dotproductloop}
}$
$\mathtt{
...
$\mathtt{
if(role == CLIENT) \{\;\;\text{\color{blue}//only to the client}
}$
$\mathtt{
