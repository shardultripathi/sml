      ...
      for uint32_t i10 = [0:32] {
        ...
        for uint32_t i11 = [0:5] {
          ...
          for uint32_t i12 = [0:13] {
            tmp7[i4][i5][i6][i10][i12] = ((tmp12<(tmp11>>1)) ? (((tmp7[i4][i5][i6][i10][(2*i12)]+tmp7[i4][i5][i6][i10][((2*i12)+1)])<2147483648) ? ((tmp7[i4][i5][i6][i10][(2*i12)]+tmp7[i4][i5][i6][i10][((2*i12)+1)])>>1) : ((((tmp7[i4][i5][i6][i10][(2*i12)]+tmp7[i4][i5][i6][i10][((2*i12)+1)])^4294967295)>>1)^4294967295)) : ((tmp12==(tmp11>>1)) ? ((tmp7[i4][i5][i6][i10][(2*i12)]<2147483648) ? (tmp7[i4][i5][i6][i10][(2*i12)]>>1) : (((tmp7[i4][i5][i6][i10][(2*i12)]^4294967295)>>1)^4294967295)) : 0));
            tmp12 = (tmp12+1);
          }
          tmp11 = ((tmp11+1)>>1);
        }
        for uint32_t i11 = [0:0] {
          tmp12 = 0;
          for uint32_t i12 = [0:13] {
            tmp7[i4][i5][i6][i10][i12] = ((tmp12<(tmp11>>1)) ? (tmp7[i4][i5][i6][i10][(2*i12)]+tmp7[i4][i5][i6][i10][((2*i12)+1)]) : ((tmp12==(tmp11>>1)) ? tmp7[i4][i5][i6][i10][(2*i12)] : 0));
            tmp12 = (tmp12+1);
          }
          tmp11 = ((tmp11+1)>>1);
        }
    ...
    for uint32_t i29 = [0:14] {
      for uint32_t i33 = [0:64] {
        ...
        for uint32_t i34 = [0:9] {
          tmp28 = 0;
          for uint32_t i35 = [0:13] {
            tmp23[i27][i28][i29][i33][i35] = ((tmp28<(tmp27>>1)) ? (tmp23[i27][i28][i29][i33][(2*i35)]+tmp23[i27][i28][i29][i33][((2*i35)+1)]) : ((tmp28==(tmp27>>1)) ? tmp23[i27][i28][i29][i33][(2*i35)] : 0));
            tmp28 = (tmp28+1);
          }
          tmp27 = ((tmp27+1)>>1);
        }
  ...
  for uint32_t i54 = [0:1024] {
    ...
    for uint32_t i55 = [0:1] {
      ...
      for uint32_t i56 = [0:1569] {
        tmp44[i52][i54][i56] = ((tmp46<(tmp45>>1)) ? (((tmp44[i52][i54][(2*i56)]+tmp44[i52][i54][((2*i56)+1)])<2147483648) ? ((tmp44[i52][i54][(2*i56)]+tmp44[i52][i54][((2*i56)+1)])>>1) : ((((tmp44[i52][i54][(2*i56)]+tmp44[i52][i54][((2*i56)+1)])^4294967295)>>1)^4294967295)) : ((tmp46==(tmp45>>1)) ? ((tmp44[i52][i54][(2*i56)]<2147483648) ? (tmp44[i52][i54][(2*i56)]>>1) : (((tmp44[i52][i54][(2*i56)]^4294967295)>>1)^4294967295)) : 0));
        tmp46 = (tmp46+1);
      }
      tmp45 = ((tmp45+1)>>1);
    }
    for uint32_t i55 = [0:11] {
      tmp46 = 0;
      for uint32_t i56 = [0:1569] {
        tmp44[i52][i54][i56] = ((tmp46<(tmp45>>1)) ? (tmp44[i52][i54][(2*i56)]+tmp44[i52][i54][((2*i56)+1)]) : ((tmp46==(tmp45>>1)) ? tmp44[i52][i54][(2*i56)] : 0));
        tmp46 = (tmp46+1);
      }
      tmp45 = ((tmp45+1)>>1);
    }
...
for uint32_t i61 = [0:1] {
  for uint32_t i63 = [0:10] {
    ...
    for uint32_t i64 = [0:9] {
      tmp56 = 0;
      for uint32_t i65 = [0:513] {
        tmp54[i61][i63][i65] = ((tmp56<(tmp55>>1)) ? (tmp54[i61][i63][(2*i65)]+tmp54[i61][i63][((2*i65)+1)]) : ((tmp56==(tmp55>>1)) ? tmp54[i61][i63][(2*i65)] : 0));
        tmp56 = (tmp56+1);
      }
      tmp55 = ((tmp55+1)>>1);
    }
