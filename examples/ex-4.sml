...
for uint32_t i2 = [0:1] {
  for uint32_t i4 = [0:1000] {
    ...
    for uint32_t i5 = [0:3] {
      tmp10 = 0;
      for uint32_t i6 = [0:4] {
        tmp8[i2][i4][i6] = ((tmp10<(tmp9>>1)) ? (((tmp8[i2][i4][(2*i6)]+tmp8[i2][i4][((2*i6)+1)])<2147483648) ? ((tmp8[i2][i4][(2*i6)]+tmp8[i2][i4][((2*i6)+1)])>>1) : ((((tmp8[i2][i4][(2*i6)]+tmp8[i2][i4][((2*i6)+1)])^4294967295)>>1)^4294967295)) : ((tmp10==(tmp9>>1)) ? ((tmp8[i2][i4][(2*i6)]<2147483648) ? (tmp8[i2][i4][(2*i6)]>>1) : (((tmp8[i2][i4][(2*i6)]^4294967295)>>1)^4294967295)) : 0));
        tmp10 = (tmp10+1);
      }
      tmp9 = ((tmp9+1)>>1);
    }
    for uint32_t i5 = [0:0] {
      tmp10 = 0;
      for uint32_t i6 = [0:4] {
        tmp8[i2][i4][i6] = ((tmp10<(tmp9>>1)) ? (tmp8[i2][i4][(2*i6)]+tmp8[i2][i4][((2*i6)+1)]) : ((tmp10==(tmp9>>1)) ? tmp8[i2][i4][(2*i6)] : 0));
        tmp10 = (tmp10+1);
      }
      tmp9 = ((tmp9+1)>>1);
    }
  ...
  for uint32_t i9 = [0:1] {
    ...
    for uint32_t i10 = [0:2] {
      ...
      for uint32_t i11 = [0:501] {
        tmp14[i7][i9][i11] = ((tmp16<(tmp15>>1)) ? (((tmp14[i7][i9][(2*i11)]+tmp14[i7][i9][((2*i11)+1)])<2147483648) ? ((tmp14[i7][i9][(2*i11)]+tmp14[i7][i9][((2*i11)+1)])>>1) : ((((tmp14[i7][i9][(2*i11)]+tmp14[i7][i9][((2*i11)+1)])^4294967295)>>1)^4294967295)) : ((tmp16==(tmp15>>1)) ? ((tmp14[i7][i9][(2*i11)]<2147483648) ? (tmp14[i7][i9][(2*i11)]>>1) : (((tmp14[i7][i9][(2*i11)]^4294967295)>>1)^4294967295)) : 0));
        tmp16 = (tmp16+1);
      }
      tmp15 = ((tmp15+1)>>1);
    }
    for uint32_t i10 = [0:8] {
      tmp16 = 0;
      for uint32_t i11 = [0:501] {
        tmp14[i7][i9][i11] = ((tmp16<(tmp15>>1)) ? (tmp14[i7][i9][(2*i11)]+tmp14[i7][i9][((2*i11)+1)]) : ((tmp16==(tmp15>>1)) ? tmp14[i7][i9][(2*i11)] : 0));
        tmp16 = (tmp16+1);
      }
      tmp15 = ((tmp15+1)>>1);
    }
  ...
  for uint32_t i14 = [0:1000] {
    ...
    for uint32_t i15 = [0:3] {
      ...
      for uint32_t i16 = [0:4] {
        tmp30[i12][i14][i16] = ((tmp32<(tmp31>>1)) ? (((tmp30[i12][i14][(2*i16)]+tmp30[i12][i14][((2*i16)+1)])<2147483648) ? ((tmp30[i12][i14][(2*i16)]+tmp30[i12][i14][((2*i16)+1)])>>1) : ((((tmp30[i12][i14][(2*i16)]+tmp30[i12][i14][((2*i16)+1)])^4294967295)>>1)^4294967295)) : ((tmp32==(tmp31>>1)) ? ((tmp30[i12][i14][(2*i16)]<2147483648) ? (tmp30[i12][i14][(2*i16)]>>1) : (((tmp30[i12][i14][(2*i16)]^4294967295)>>1)^4294967295)) : 0));
        tmp32 = (tmp32+1);
      }
      tmp31 = ((tmp31+1)>>1);
    }
    for uint32_t i15 = [0:0] {
      tmp32 = 0;
      for uint32_t i16 = [0:4] {
        tmp30[i12][i14][i16] = ((tmp32<(tmp31>>1)) ? (tmp30[i12][i14][(2*i16)]+tmp30[i12][i14][((2*i16)+1)]) : ((tmp32==(tmp31>>1)) ? tmp30[i12][i14][(2*i16)] : 0));
        tmp32 = (tmp32+1);
      }
      tmp31 = ((tmp31+1)>>1);
    }
  ...
  for uint32_t i19 = [0:1] {
    ...
    for uint32_t i20 = [0:0] {
      ...
      for uint32_t i21 = [0:501] {
        tmp36[i17][i19][i21] = ((tmp38<(tmp37>>1)) ? (((tmp36[i17][i19][(2*i21)]+tmp36[i17][i19][((2*i21)+1)])<2147483648) ? ((tmp36[i17][i19][(2*i21)]+tmp36[i17][i19][((2*i21)+1)])>>1) : ((((tmp36[i17][i19][(2*i21)]+tmp36[i17][i19][((2*i21)+1)])^4294967295)>>1)^4294967295)) : ((tmp38==(tmp37>>1)) ? ((tmp36[i17][i19][(2*i21)]<2147483648) ? (tmp36[i17][i19][(2*i21)]>>1) : (((tmp36[i17][i19][(2*i21)]^4294967295)>>1)^4294967295)) : 0));
        tmp38 = (tmp38+1);
      }
      tmp37 = ((tmp37+1)>>1);
    }
    for uint32_t i20 = [0:10] {
      tmp38 = 0;
      for uint32_t i21 = [0:501] {
        tmp36[i17][i19][i21] = ((tmp38<(tmp37>>1)) ? (tmp36[i17][i19][(2*i21)]+tmp36[i17][i19][((2*i21)+1)]) : ((tmp38==(tmp37>>1)) ? tmp36[i17][i19][(2*i21)] : 0));
        tmp38 = (tmp38+1);
      }
      tmp37 = ((tmp37+1)>>1);
    }
  ...
  for uint32_t i26 = [0:1000] {
    ...
    for uint32_t i27 = [0:3] {
      ...
      for uint32_t i28 = [0:4] {
        tmp45[i24][i26][i28] = ((tmp47<(tmp46>>1)) ? (((tmp45[i24][i26][(2*i28)]+tmp45[i24][i26][((2*i28)+1)])<2147483648) ? ((tmp45[i24][i26][(2*i28)]+tmp45[i24][i26][((2*i28)+1)])>>1) : ((((tmp45[i24][i26][(2*i28)]+tmp45[i24][i26][((2*i28)+1)])^4294967295)>>1)^4294967295)) : ((tmp47==(tmp46>>1)) ? ((tmp45[i24][i26][(2*i28)]<2147483648) ? (tmp45[i24][i26][(2*i28)]>>1) : (((tmp45[i24][i26][(2*i28)]^4294967295)>>1)^4294967295)) : 0));
        tmp47 = (tmp47+1);
      }
      tmp46 = ((tmp46+1)>>1);
    }
    for uint32_t i27 = [0:0] {
      tmp47 = 0;
      for uint32_t i28 = [0:4] {
        tmp45[i24][i26][i28] = ((tmp47<(tmp46>>1)) ? (tmp45[i24][i26][(2*i28)]+tmp45[i24][i26][((2*i28)+1)]) : ((tmp47==(tmp46>>1)) ? tmp45[i24][i26][(2*i28)] : 0));
        tmp47 = (tmp47+1);
      }
      tmp46 = ((tmp46+1)>>1);
    }
  ...
  for uint32_t i31 = [0:1] {
    ...
    for uint32_t i32 = [0:0] {
      ...
      for uint32_t i33 = [0:501] {
        tmp51[i29][i31][i33] = ((tmp53<(tmp52>>1)) ? (((tmp51[i29][i31][(2*i33)]+tmp51[i29][i31][((2*i33)+1)])<2147483648) ? ((tmp51[i29][i31][(2*i33)]+tmp51[i29][i31][((2*i33)+1)])>>1) : ((((tmp51[i29][i31][(2*i33)]+tmp51[i29][i31][((2*i33)+1)])^4294967295)>>1)^4294967295)) : ((tmp53==(tmp52>>1)) ? ((tmp51[i29][i31][(2*i33)]<2147483648) ? (tmp51[i29][i31][(2*i33)]>>1) : (((tmp51[i29][i31][(2*i33)]^4294967295)>>1)^4294967295)) : 0));
        tmp53 = (tmp53+1);
      }
      tmp52 = ((tmp52+1)>>1);
    }
    for uint32_t i32 = [0:10] {
      tmp53 = 0;
      for uint32_t i33 = [0:501] {
        tmp51[i29][i31][i33] = ((tmp53<(tmp52>>1)) ? (tmp51[i29][i31][(2*i33)]+tmp51[i29][i31][((2*i33)+1)]) : ((tmp53==(tmp52>>1)) ? tmp51[i29][i31][(2*i33)] : 0));
        tmp53 = (tmp53+1);
      }
      tmp52 = ((tmp52+1)>>1);
    }
  ...
  for uint32_t i38 = [0:1000] {
    ...
    for uint32_t i39 = [0:3] {
      ...
      for uint32_t i40 = [0:4] {
        tmp60[i36][i38][i40] = ((tmp62<(tmp61>>1)) ? (((tmp60[i36][i38][(2*i40)]+tmp60[i36][i38][((2*i40)+1)])<2147483648) ? ((tmp60[i36][i38][(2*i40)]+tmp60[i36][i38][((2*i40)+1)])>>1) : ((((tmp60[i36][i38][(2*i40)]+tmp60[i36][i38][((2*i40)+1)])^4294967295)>>1)^4294967295)) : ((tmp62==(tmp61>>1)) ? ((tmp60[i36][i38][(2*i40)]<2147483648) ? (tmp60[i36][i38][(2*i40)]>>1) : (((tmp60[i36][i38][(2*i40)]^4294967295)>>1)^4294967295)) : 0));
        tmp62 = (tmp62+1);
      }
      tmp61 = ((tmp61+1)>>1);
    }
    for uint32_t i39 = [0:0] {
      tmp62 = 0;
      for uint32_t i40 = [0:4] {
        tmp60[i36][i38][i40] = ((tmp62<(tmp61>>1)) ? (tmp60[i36][i38][(2*i40)]+tmp60[i36][i38][((2*i40)+1)]) : ((tmp62==(tmp61>>1)) ? tmp60[i36][i38][(2*i40)] : 0));
        tmp62 = (tmp62+1);
      }
      tmp61 = ((tmp61+1)>>1);
    }
...
for uint32_t i41 = [0:1] {
  for uint32_t i43 = [0:1] {
    ...
    for uint32_t i44 = [0:8] {
      tmp68 = 0;
      for uint32_t i45 = [0:501] {
        tmp66[i41][i43][i45] = ((tmp68<(tmp67>>1)) ? (tmp66[i41][i43][(2*i45)]+tmp66[i41][i43][((2*i45)+1)]) : ((tmp68==(tmp67>>1)) ? tmp66[i41][i43][(2*i45)] : 0));
        tmp68 = (tmp68+1);
      }
      tmp67 = ((tmp67+1)>>1);
    }
  ...
  for uint32_t i48 = [0:1000] {
    ...
    for uint32_t i49 = [0:3] {
      ...
      for uint32_t i50 = [0:4] {
        tmp82[i46][i48][i50] = ((tmp84<(tmp83>>1)) ? (((tmp82[i46][i48][(2*i50)]+tmp82[i46][i48][((2*i50)+1)])<2147483648) ? ((tmp82[i46][i48][(2*i50)]+tmp82[i46][i48][((2*i50)+1)])>>1) : ((((tmp82[i46][i48][(2*i50)]+tmp82[i46][i48][((2*i50)+1)])^4294967295)>>1)^4294967295)) : ((tmp84==(tmp83>>1)) ? ((tmp82[i46][i48][(2*i50)]<2147483648) ? (tmp82[i46][i48][(2*i50)]>>1) : (((tmp82[i46][i48][(2*i50)]^4294967295)>>1)^4294967295)) : 0));
        tmp84 = (tmp84+1);
      }
      tmp83 = ((tmp83+1)>>1);
    }
    for uint32_t i49 = [0:0] {
      tmp84 = 0;
      for uint32_t i50 = [0:4] {
        tmp82[i46][i48][i50] = ((tmp84<(tmp83>>1)) ? (tmp82[i46][i48][(2*i50)]+tmp82[i46][i48][((2*i50)+1)]) : ((tmp84==(tmp83>>1)) ? tmp82[i46][i48][(2*i50)] : 0));
        tmp84 = (tmp84+1);
      }
      tmp83 = ((tmp83+1)>>1);
    }
  ...
  for uint32_t i53 = [0:1] {
    ...
    for uint32_t i54 = [0:0] {
      ...
      for uint32_t i55 = [0:501] {
        tmp88[i51][i53][i55] = ((tmp90<(tmp89>>1)) ? (((tmp88[i51][i53][(2*i55)]+tmp88[i51][i53][((2*i55)+1)])<2147483648) ? ((tmp88[i51][i53][(2*i55)]+tmp88[i51][i53][((2*i55)+1)])>>1) : ((((tmp88[i51][i53][(2*i55)]+tmp88[i51][i53][((2*i55)+1)])^4294967295)>>1)^4294967295)) : ((tmp90==(tmp89>>1)) ? ((tmp88[i51][i53][(2*i55)]<2147483648) ? (tmp88[i51][i53][(2*i55)]>>1) : (((tmp88[i51][i53][(2*i55)]^4294967295)>>1)^4294967295)) : 0));
        tmp90 = (tmp90+1);
      }
      tmp89 = ((tmp89+1)>>1);
    }
    for uint32_t i54 = [0:10] {
      tmp90 = 0;
      for uint32_t i55 = [0:501] {
        tmp88[i51][i53][i55] = ((tmp90<(tmp89>>1)) ? (tmp88[i51][i53][(2*i55)]+tmp88[i51][i53][((2*i55)+1)]) : ((tmp90==(tmp89>>1)) ? tmp88[i51][i53][(2*i55)] : 0));
        tmp90 = (tmp90+1);
      }
      tmp89 = ((tmp89+1)>>1);
    }
